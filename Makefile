run_app:
	...
	wget -q -O pages_files/_dash-layout.json http://127.0.0.1:8050/_dash-layout || echo "Failed to download _dash-layout"
	wget -q -O pages_files/_dash-dependencies.json http://127.0.0.1:8050/_dash-dependencies || echo "Failed to download _dash-dependencies"

	# Download component files while removing "127.0.0.1:8050/" from the directory structure
	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-graph.js || echo "Failed to download async-graph.js"
	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-highlight.js || echo "Failed to download async-highlight.js"
	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-markdown.js || echo "Failed to download async-markdown.js"
	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dcc/async-datepicker.js || echo "Failed to download async-datepicker.js"

	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dash_table/async-table.js || echo "Failed to download async-table.js"
	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/dash/dash_table/async-highlight.js || echo "Failed to download async-highlight.js"

	wget -r -np -nH --cut-dirs=1 -P pages_files http://127.0.0.1:8050/_dash-component-suites/plotly/package_data/plotly.min.js || echo "Failed to download plotly.min.js"
	...
	if [ -d "pages_files" ] && [ "$(ls -A pages_files)" ]; then \
